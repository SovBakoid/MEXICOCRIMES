...
Я нашел сырые данные на официльном сайте про каждое отдельное преступление, совершенное в Мехико,
 ...
 Также важно понимать, что перечисленные ниже числа для каждого из преступлений включают в себя все подвиды данных преступлений, то есть, например, убийства включают в себя также и те, что совершены по ошибки и тп. Это особенно актуально для 'травм'""")
...
st.write("""
Резюмируя, надо сказать, что Мехико реально безопасный город, если не посещать трущебы на окраинах города, не таскать с собой все свои сбережения по людным улицам, не пользоваться случайными нелицензионными такси и не ввзяваться в конфликты самому. Одним словом, если не вести себя как идиот.
""")
